import { DefaultObjectItemType, DefaultObjectsItemType } from "../_types/general";
...
export const renameFiledObjectArray = (arr: DefaultObjectsItemType, field: string, newField: string) => {

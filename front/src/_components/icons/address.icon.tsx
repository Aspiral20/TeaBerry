...
const AddressIcon: FC<React.SVGAttributes<SVGElement>> = ({
  className = '',
  ...rest
}) => {
  return (
    <svg
      className={"address_icon " + className}
      {...rest}
      width={50}
      height={50}
      data-name="Layer 1"
    ...
    >
      <path className="address_icon_path-1"
      ...
      <path className="address_icon_path-2"
